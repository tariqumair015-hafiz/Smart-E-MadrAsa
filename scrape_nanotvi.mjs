...
const SUB_CATEGORY = 'maulana-qasim-nanotvi';
const YEAR = 0;
const BASE_URL = 'https://besturdubooks.net/tag/maulana-qasim-nanotvi-books/';
const TOTAL_PAGES = 3;
...
async function run() {
  ...
  fs.writeFileSync('nanotvi_books.json', JSON.stringify(books, null, 2), 'utf8');
  if (books.length > 0) {
