...
const filePath = 'c:/Users/ut304/.gemini/antigravity/scratch/hafiz-madarsa-pro-v2/daura_books_expanded.json';
const data = JSON.parse(fs.readFileSync(filePath, 'utf8'));

async function upload() {
  console.log(`Upserting ${data.length} distinct publisher books for دورہ حدیث...`);
