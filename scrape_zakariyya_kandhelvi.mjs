...
const SUB_CATEGORY = 'maulana-zakariyya-kandhelvi';
const BASE_URL = 'https://besturdubooks.net/tag/shaykh-ul-hadith-muhammad-zakariyya-kandhelvi-books/';
const TOTAL_PAGES = 4;
...
async function scrapeAll() {
  ...
  console.log(`\n📊 Upload Summary - Successfully uploaded: ${uploadCount}/${allBooks.length}`);
