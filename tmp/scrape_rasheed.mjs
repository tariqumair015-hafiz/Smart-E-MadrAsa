...
async function run() {
  const baseUrl = 'https://besturdubooks.net/tag/maulana-abdur-rasheed-nomani-books';
    ...
    try {
      ...
      $('a').each((i, el) => {
        ...
        if (href && href.startsWith('https://besturdubooks.net/') && 
            ...
            !href.includes('maulana-abdur-rasheed-nomani-books')) {
  ...
  for (let i = 0; i < finalLinks.length; i++) {
    ...
    try {
      ...
      if (volumes.length > 0) {
        allBooks.push({
          title: title,
          author: "Maulana Abdur Rasheed Nomani",
          category: 'علمائے کرام',
          sub_category: 'maulana-abdur-rasheed-nomani',
          cover_url: bookImg,
