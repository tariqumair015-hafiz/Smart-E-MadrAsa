...
async function run() {
  ...
  for (let page = 1; page <= 5; page++) {
    const url = page === 1
      ? 'https://besturdubooks.net/category/ahkam-o-masail/nikah-o-talaq/'
      : `https://besturdubooks.net/category/ahkam-o-masail/nikah-o-talaq/page/${page}/`;
        ...
        try {
          ...
          if (volumes.length > 0 && img && title) {
            allBooks.push({
              title,
              author: 'نامعلوم',
              category: 'نکاح و طلاق', // "Marriage & Divorce"
              cover_url: img,
  ...
  console.log(`\nTotal books found for Marriage & Divorce: ${allBooks.length}`);
  ...
  if (allBooks.length > 0) {
    ...
    console.log('🎉 All Marriage & Divorce books inserted successfully!');
  }
}
