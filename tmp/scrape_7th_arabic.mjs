...
async function run() {
    const allBooks = [];
    const baseUrl = 'http://besturdubooks.net/dars-e-nizami/maoqoof-alai-7th-year/maoqoof-alai-arabic-shuroohat/';
    const totalPages = 2; // Iterating over the 2 pages specified by user
