...
async function run() {
  ...
  for (let page = 1; page <= 29; page++) {
    const url = page === 1
      ? 'https://besturdubooks.net/category/tafseer-ul-quran/'
      : `https://besturdubooks.net/category/tafseer-ul-quran/page/${page}/`;

    console.log(`Scraping page ${page}/29: ${url}...`);
    try {
  ...
  if (allBooks.length > 0) {
    ...
    console.log('🎉 All Tafseer ul Quran books inserted successfully!');
  }
}
