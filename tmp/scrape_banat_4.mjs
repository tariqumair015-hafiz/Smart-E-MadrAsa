...
async function run() {
  const landingUrl = 'https://besturdubooks.net/dars-e-nizami-banat-girls/aliyah-banat-second-year-books/';
  ...
  $l('.entry-content a').each((i, el) => {
      ...
      if (href && href.startsWith('https://besturdubooks.net/') && 
          ...
          // Use search patterns consistent with the app's internal logic
