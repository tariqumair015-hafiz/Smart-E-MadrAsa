...
async function run() {
  ...
  for (let page = 1; page <= 4; page++) {
    const url = page === 1
      ? 'https://besturdubooks.net/category/falkiyaat/'
      : `https://besturdubooks.net/category/falkiyaat/page/${page}/`;
  ...
  console.log(`\nTotal books found for Astronomy category: ${allBooks.length}`);
  ...
  if (allBooks.length > 0) {
    ...
    console.log('🎉 All Astronomy books inserted successfully!');
  }
}
