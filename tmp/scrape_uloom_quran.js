...
async function run() {
  ...
  for (let page = 1; page <= 11; page++) {
    const url = page === 1
      ? 'https://besturdubooks.net/category/uloom-e-quran/'
      : `https://besturdubooks.net/category/uloom-e-quran/page/${page}/`;

    console.log(`Scraping page ${page}/11: ${url}...`);
    try {
  ...
  console.log(`\nTotal books found for Uloom ul Quran: ${allBooks.length}`);
