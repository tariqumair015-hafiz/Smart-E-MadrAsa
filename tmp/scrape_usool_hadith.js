...
async function run() {
  ...
  for (let page = 1; page <= 21; page++) {
    const url = page === 1
      ? 'https://besturdubooks.net/category/usool-e-hadith/'
      : `https://besturdubooks.net/category/usool-e-hadith/page/${page}/`;
  ...
  console.log(`\nTotal books found for Usool Hadith: ${allBooks.length}`);
  ...
  if (allBooks.length > 0) {
    ...
    console.log('🎉 All Usool Hadith books inserted successfully!');
  }
}
