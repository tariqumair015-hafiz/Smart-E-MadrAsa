...
async function run() {
  const baseUrl = 'https://besturdubooks.net/tag/maulana-khalid-saifullah-rahmani-books';
    ...
    try {
      ...
      $('a').each((i, el) => {
        ...
        if (href && href.startsWith('https://besturdubooks.net/') && 
            ...
            !href.includes('maulana-khalid-saifullah-rahmani-books')) {
    ...
    try {
      ...
      if (volumes.length > 0) {
        allBooks.push({
          ...
          sub_category: 'maulana-khalid-saifullah-rahmani',
          cover_url: bookImg,
