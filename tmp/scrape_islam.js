...
async function run() {
  ...
  for (let page = 1; page <= 14; page++) {
    const url = page === 1
      ? 'https://besturdubooks.net/category/islam/'
      : `https://besturdubooks.net/category/islam/page/${page}/`;
  ...
  console.log(`\nTotal books found for Islam category: ${allBooks.length}`);
  ...
  if (allBooks.length > 0) {
    ...
    console.log('🎉 All Islam books inserted successfully!');
  }
}
