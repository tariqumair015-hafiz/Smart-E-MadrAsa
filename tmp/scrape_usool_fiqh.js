...
async function run() {
  ...
  for (let page = 1; page <= 22; page++) {
    const url = page === 1
      ? 'https://besturdubooks.net/category/usool-e-fiqh/'
      : `https://besturdubooks.net/category/usool-e-fiqh/page/${page}/`;

    console.log(`Scraping page ${page}/22: ${url}...`);
    try {
  ...
  console.log(`\nTotal books found for Usool Fiqh: ${allBooks.length}`);
  ...
  if (allBooks.length > 0) {
    ...
    console.log('🎉 All Usool Fiqh books inserted successfully!');
  }
}
