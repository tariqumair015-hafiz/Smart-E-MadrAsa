...
async function run() {
  ...
  for (let page = 1; page <= 57; page++) {
    const url = page === 1
      ? 'https://besturdubooks.net/category/ahkam-o-masail/'
      : `https://besturdubooks.net/category/ahkam-o-masail/page/${page}/`;

    console.log(`Scraping page ${page}/57: ${url}...`);
    try {
  ...
  console.log(`\nTotal books found for Ahkam & Masail: ${allBooks.length}`);
  ...
  if (allBooks.length > 0) {
    ...
    console.log('🎉 All Ahkam & Masail books inserted successfully!');
  }
}
