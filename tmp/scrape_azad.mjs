...
async function run() {
  const baseUrl = 'https://besturdubooks.net/tag/maulana-abul-kalam-azad-books';
    ...
    try {
      ...
      $('a').each((i, el) => {
        ...
        if (href && href.startsWith('https://besturdubooks.net/') && 
            ...
            !href.includes('maulana-abul-kalam-azad-books')) {
    ...
    try {
      ...
      if (volumes.length > 0) {
        allBooks.push({
          ...
          sub_category: 'maulana-abul-kalam-azad',
          cover_url: bookImg,
