...
async function run() {
  ...
  for (let page = 1; page <= 19; page++) {
    const url = page === 1
      ? 'https://besturdubooks.net/category/tareekh/'
      : `https://besturdubooks.net/category/tareekh/page/${page}/`;
  ...
  console.log(`\nTotal books found for History category: ${allBooks.length}`);
  ...
  if (allBooks.length > 0) {
    ...
    console.log('🎉 All History books inserted successfully!');
  }
}
