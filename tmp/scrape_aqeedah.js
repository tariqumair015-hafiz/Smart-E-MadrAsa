...
async function run() {
  ...
  for (let page = 1; page <= 26; page++) {
    const url = page === 1
      ? 'https://besturdubooks.net/category/aqaid-o-kalam/'
      : `https://besturdubooks.net/category/aqaid-o-kalam/page/${page}/`;

    console.log(`Scraping page ${page}/26: ${url}...`);
    try {
  ...
  console.log(`\nTotal books found for Aqeedah category: ${allBooks.length}`);
  ...
  if (allBooks.length > 0) {
    ...
    console.log('🎉 All Aqeedah books inserted successfully!');
  }
}
