...
async function run() {
  const baseUrl = 'https://besturdubooks.net/tag/maulana-abdul-majid-daryabadi-books';
    ...
    try {
      ...
      $('a').each((i, el) => {
        ...
        if (href && href.startsWith('https://besturdubooks.net/') && 
            ...
            !href.includes('abdul-majid-daryabadi-books')) {
    ...
    try {
      ...
      if (volumes.length > 0) {
        allBooks.push({
          ...
          sub_category: 'maulana-abdul-majid-daryabadi',
          cover_url: bookImg,
