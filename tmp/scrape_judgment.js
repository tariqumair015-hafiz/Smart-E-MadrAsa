...
async function run() {
  ...
  for (let page = 1; page <= 6; page++) {
    const url = page === 1
      ? 'https://besturdubooks.net/category/qiamat/'
      : `https://besturdubooks.net/category/qiamat/page/${page}/`;
  ...
  console.log(`\nTotal books found for Judgment Day category: ${allBooks.length}`);
  ...
  if (allBooks.length > 0) {
    ...
    console.log('🎉 All Judgment Day books inserted successfully!');
  }
}
