...
async function run() {
  ...
  for (let page = 1; page <= 7; page++) {
    const url = page === 1
      ? 'https://besturdubooks.net/category/tajweed-o-qirat/'
      : `https://besturdubooks.net/category/tajweed-o-qirat/page/${page}/`;
  ...
  console.log(`\nTotal books found for Tajweed & Qiraat: ${allBooks.length}`);
  ...
  if (allBooks.length > 0) {
    ...
    console.log('🎉 All Tajweed & Qiraat books inserted successfully!');
  }
}
