...
async function run() {
  const landingUrl = 'https://besturdubooks.net/dars-e-nizami-banat-girls/aliyah-banat-first-year-books/';
  ...
  $l('.entry-content a').each((i, el) => {
      ...
      // If the link contains an image and no text, try to extract from parent or nearby
      if (!text) {
