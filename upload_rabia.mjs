...
const data = JSON.parse(fs.readFileSync('c:/Users/ut304/.gemini/antigravity/scratch/hafiz-madarsa-pro-v2/rabia_books.json', 'utf8'));

async function upload() {
  console.log(`Uploading ${data.length} books for درجہ رابعہ...`);
