...
async function verify() {
  console.log('\n🔍 Verifying Maulana Roohullah Naqshbandi Books in Supabase...\n');
  
  // Query all Naqshbandi books
  const { data, error } = await supabase
    .from('Books')
    .select('title, author, cover_url, pdf_url, sub_category')
  ...
  console.log(`✅ Found ${data.length} books for Maulana Roohullah Naqshbandi\n`);
