...
const SUB_CATEGORY = 'maulana-sarfaraz-safdar';
const YEAR = 0;
const BASE_URL = 'https://besturdubooks.net/tag/maulana-sarfaraz-khan-safdar-books/';
const TOTAL_PAGES = 5;
...
async function run() {
  ...
  fs.writeFileSync('safdar_books.json', JSON.stringify(books, null, 2), 'utf8');
  if (books.length > 0) {
